                            ...
                            <ul>
                                <div className="tablaVentasProducto">
                                    ...
                                    <li className= "tablaVenta2">
                                        ...
                                        <div className = "cuadroValorTotal cuadroTabla infoAgregarVenta inputAgregarventa" > <input type="number" onChange={handleInputChange} name="id_venta" size="40" value={nuevaInfo.id_venta}/></div>
